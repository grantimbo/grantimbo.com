    ...
    return (
      ...
      >
        ...
        <div className="flex items-center">
          <div>
            <motion.h3
              className="text-eggblue mb-2 text-base font-medium md:mb-4 md:text-2xl"
            ...
            <motion.p
              className="text-xs leading-tight text-blue-300/50 sm:text-sm md:text-base md:leading-tight"
              animate={dropInanimate}
              initial={dropIninitial}
              transition={{
      ...
      >
        <div className="flex items-center">
          <div>
            ...
            <motion.p
              className="text-xs text-blue-300/50 sm:text-sm md:text-base md:leading-tight"
              animate={dropInanimate}
              initial={dropIninitial}
              transition={{
                delay: service.delay + 0.1,
